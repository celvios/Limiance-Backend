...
func TemplateForEvent(eventType string) (TransactionalEmail, bool) {
	templates := map[string]TransactionalEmail{
		...
		"security.withdrawal_address_whitelisted": {"Withdrawal address whitelisted", "Withdrawal address added to your whitelist", "A withdrawal address was added to your trusted whitelist. Withdrawals to this address will not require two-factor verification. If you did not make this change, secure your account immediately."},
	}
